...
// Error codes are grouped by category for clarity, based on the RP1210C standard or vendor-specific extensions.
var RP1210Errors = map[uint16]string{
    ...
    // API-specific errors (non-standard, vendor or wrapper API extensions)
    3000: "API_RP1210_INI_NOT_FOUND",
    3001: "API_VENDOR_INI_FILE_NOT_FOUND",
    ...
    // Add additional vendor-specific or standard codes as needed
}
